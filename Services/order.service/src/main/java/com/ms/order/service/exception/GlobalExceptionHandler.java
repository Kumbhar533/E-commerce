...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<String> handleCustomerNotFound(final BussinessException exception) {
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(exception.mes);
	}
